...
with DAG(
    "amc_ntb_customers_by_asin",
    default_args=default_args,
    description="DAG responsável pela análise de consumidores ntb por asin",
    ...
    with TaskGroup("setup", tooltip="Configuração de parâmetros e autenticação") as setup:
        set_params_task = PythonOperator(
            ...
            op_kwargs={
                ...
                "query": Query.amc_ntb_customers_by_asin,
                "table_name": "amc_ntb_customers_by_asin",
            },
        )
