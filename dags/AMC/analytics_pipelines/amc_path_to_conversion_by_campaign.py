...
with DAG(
    "amc_path_to_conversion_by_campaign",
    default_args=default_args,
    description="DAG responsável pela análise de jornada de conversão por campanha",
    ...
    with TaskGroup("setup", tooltip="Configuração de parâmetros e autenticação") as setup:
        set_params_task = PythonOperator(
            ...
            op_kwargs={
                ...
                "query": Query.amc_path_to_conversion_by_campaign,
                "table_name": "amc_path_to_conversion_by_campaign",
            },
        )
